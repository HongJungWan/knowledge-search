package com.hris.knowledgesearch.domain.knowledge.repository.custom.impl;

import com.hris.knowledgesearch.domain.knowledge.entity.KnowledgeRecord;
import com.hris.knowledgesearch.domain.knowledge.entity.QKnowledgeRecord;
...
/**
 * 지식 레코드 QueryDSL 커스텀 구현 (PRD §6).
 * <p>
 * 자유 입력 SQL 을 받지 않는다. 허용된 조건(domain/keyword/code-value)을 {@link BooleanBuilder} 로만 조립한다.
 * 랭킹은 완전일치 &gt; 코드값일치 &gt; 부분일치 순으로 점수를 매기고, 그 안에서 source_updated_at 최신순으로 둔다.
 * <p>
...
public class KnowledgeRecordRepositoryCustomImpl implements KnowledgeRecordRepositoryCustom {
