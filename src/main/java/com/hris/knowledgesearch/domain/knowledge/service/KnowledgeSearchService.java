package com.hris.knowledgesearch.domain.knowledge.service;

import com.hris.knowledgesearch.domain.knowledge.dto.KnowledgeDetailResponse;
import com.hris.knowledgesearch.domain.knowledge.dto.KnowledgeSummaryResponse;
import com.hris.knowledgesearch.domain.knowledge.dto.SchemaInfoResponse;
...
import com.hris.knowledgesearch.domain.knowledge.repository.KnowledgeRecordRepository;
 ...
 * 지식 검색 서비스 (PRD §5/§6/§9).
 * <p>
 * 흐름: metadata 로 질의 정규화·매핑(활성 시) → QueryDSL 조건 검색 → 요약/출처 반환 → SearchLog 기록.
 */
@Slf4j
@Service
