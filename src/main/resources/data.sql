...
-- content_hash 는 데모용 고정 더미값 — 엔티티가 문서화한 64-hex 형식을 따르는 더미(실제 SHA-256 과 충돌 확률 무시 가능).
...
('SETTLEMENT', '정산 주기 및 마감 정책',
 ...
 TIMESTAMP '2026-06-01 09:00:00', '1111111111111111111111111111111111111111111111111111111111110001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('SETTLEMENT', '가맹점 수수료율 체계',
 ...
 TIMESTAMP '2026-06-02 09:00:00', '1111111111111111111111111111111111111111111111111111111111110002', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('SETTLEMENT', '미정산 거래(PENDING) 처리 기준',
 ...
 TIMESTAMP '2026-06-03 09:00:00', '1111111111111111111111111111111111111111111111111111111111110003', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('SETTLEMENT', '정산 보류(HOLD) 사유 및 해제',
 ...
 TIMESTAMP '2026-06-04 09:00:00', '1111111111111111111111111111111111111111111111111111111111110004', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('SETTLEMENT', '정산 지급일 규칙(T+2)',
 ...
 TIMESTAMP '2026-06-05 09:00:00', '1111111111111111111111111111111111111111111111111111111111110005', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
